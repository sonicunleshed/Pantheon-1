        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 bg-card border border-gray-700 rounded-md focus:ring-primary-500 focus:border-primary-500 text-foreground"
                    />
                  </div>
                  <div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-300">(123) 456-7890</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-300">info@pantheon.com</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-300">123 Education Street</p>
              ...
              <div className="mt-10">
                <h3 className="text-lg font-semibold mb-4 text-foreground">Book a Free Consultation</h3>
                <p className="text-gray-300 mb-4">
                  Schedule a 30-minute consultation with one of our education experts to discuss your academic goals.
                </p>
                <a
                  href="#"
                  className="px-6 py-3 bg-primary-500 text-primary-foreground font-medium rounded-lg shadow-md hover:bg-primary-600 transition-all duration-300 inline-block"
                >
                  Book Consultation
                </a>
              </div>
